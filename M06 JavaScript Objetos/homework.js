...
function multiplicarNumeroDesconocidoPorCinco(objetoMisterioso) {
   ...
   // Tu código:
   var objeto2= objetoMisterioso;
   var num = objeto2.numeroMisterioso;
   num = num*5;
   return num;
}
...
function tienePropiedad(objeto, propiedad) {
   ...
   // Tu código:
   var objeto2= objeto;
   if (objeto2.hasOwnProperty(propiedad)=== true){
      return true;
   }else {
      return false;
   }
...
function agregarMetodoCalculoDescuento(objetoProducto) {
   ...
   // Precio final ---> 8
   // Tu código:
   var objeto=objetoProducto;
   objeto.calcularPrecioDescuento= function(){
